    ...
    <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
      <div class="flex-row text-center mx-auto">
        ...
        <div class="mx-auto">
          ...
          <p>
            Confirme la contraseña por razones de seguridad o <br> restablecerlo haciendo clic en contraseña olvidada.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <p class="text-start mb-4">
          Por favor, confirme su contraseña antes de continuar.</p>
        <p class="mb-0 fw-semibold">Escriba su código de seguridad de 6 dígitos</p>
